...
BASE_OUT_ROOT="/home/yzhong/data/storage2/gits/CNN-PD-Voice/outputs/inception_runs_5fold_early_persp_5seeds"
...
for task in "${TASKSET[@]}"; do
  ...
  for run_idx in 1 2 3 4 5; do
    ...
    for k in 1 2 3 4 5; do
      ...
      train_tsv="$fold_dir/sub_splits/train_early_persp.tsv"
